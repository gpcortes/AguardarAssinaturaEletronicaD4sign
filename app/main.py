...
def tokenRequired(function):
    ...
    def decorated(*args, **kwargs):
        ...
        try:
            jwt.decode(token, signature_service.D4SIGN_HMAC_KEY, algorithms=['HS256'])
        except:
        ...
        if 'message' in request.json:
            if request.json['type_post'] == "1":
                ...
                for task in tasks:
                    ...
                    signed_document = signature_service.download_document(task.variables['uuid_document'].value)
                    home = os.path.expanduser("~")
